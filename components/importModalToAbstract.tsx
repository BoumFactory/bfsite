...
interface SimpleModalToAbstractProps {
  isOpen: boolean;
  closeModal: () => void;
...
const SimpleModalToAbstract: React.FC<SimpleModalToAbstractProps> = ({
  isOpen,
  closeModal,
  onExerciseImported,
  taskType
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const abstractionResult = await abstractExercise(content,instruct, apiFileType, modelToUse, taskType);
      ...
      <div className="relative p-4 flex justify-center items-center min-h-screen">
        <div className="relative w-full max-w-2xl bg-white p-6 rounded-lg shadow-xl">
          ...
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-medium">Abstraire un exercice mathématique</h3>
            <button 
          ...
          <div className="mt-4">
            ...
            <div className="mb-4">
              ...
              <div
                className={`mt-4 border-2 border-dashed rounded-md p-6 flex flex-col items-center justify-center cursor-pointer ${
                ...
                {fileName ? (
                  <>
                    ...
                    <p className="text-sm text-gray-600">
                      Type détecté: {fileType === 'latex' ? 'LaTeX' : fileType.toUpperCase()}
                    </p>
                  </>
                ) : (
                  <>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Formats supportés: .tex, .pdf, .docx, .jpg, .png
                    </p>
                  </>
                )}
                <input
                  ...
                  accept=".tex,.pdf,.docx,.jpg,.png,.jpeg,.gif,.txt"
                />
              </div>
            </div>
...
export default SimpleModalToAbstract;